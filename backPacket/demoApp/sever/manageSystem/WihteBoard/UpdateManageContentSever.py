...
完成时间：2023/4/24
"""
class UpdateManageContentSever:
    ...
    @:author 常舜志
    """
    def updateManageContentSever(self,updateContentTO):
        try:
            ...
            # modeKey=4,代表置顶设置，读取topMess
            elif(modeKey == 4):
                topMess = whiteBoardContent.getTopMess()
                updateContentTOS2D = self.keyUpdate("topMess",topMess,valueDict)
            # 非法请求
            else:
